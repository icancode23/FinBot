...
//MILKMAN ACTIVITY
//Currently this activity has been disabled as the finbot activity has been set as launcher
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  fab.setOnClickListener(new View.OnClickListener() {
        ...
        t1=(TextView)findViewById(R.id.oo);
        t2=(TextView)findViewById(R.id.too);
